...
form_class = uic.loadUiType("domestic_sales-ny.ui")[0]
...
class MyWindowClass(QtWidgets.QDialog, form_class):
	...
	def update_totals(self):
		...
		self.lblTotalSalesAnual.setText(str(Total_Conv_Anual))
	...
	def inicializar_campós(self):
		...
		"""
		self.lEditConvBroccJan.insert(str(0))
		self.lEditConvBroccFeb.insert(str(0))
		self.lEditConvBroccMar.insert(str(0))
		self.lEditConvBroccApr.insert(str(0))
		self.lEditConvBroccMay.insert(str(0))
		self.lEditConvBroccJun.insert(str(0))
		self.lEditConvBroccJul.insert(str(0))
		self.lEditConvBroccAug.insert(str(0))
		self.lEditConvBroccSep.insert(str(0))
		self.lEditConvBroccOct.insert(str(0))
		self.lEditConvBroccNov.insert(str(0))
		self.lEditConvBroccDec.insert(str(0))

		self.lEditOrgBroccJan.insert(str(0))
		self.lEditOrgBroccFeb.insert(str(0))
		self.lEditOrgBroccMar.insert(str(0))
		self.lEditOrgBroccApr.insert(str(0))
		self.lEditOrgBroccMay.insert(str(0))
		self.lEditOrgBroccJun.insert(str(0))
		self.lEditOrgBroccJul.insert(str(0))
		self.lEditOrgBroccAug.insert(str(0))
		self.lEditOrgBroccSep.insert(str(0))
		self.lEditOrgBroccOct.insert(str(0))
		self.lEditOrgBroccNov.insert(str(0))
		self.lEditOrgBroccDec.insert(str(0))
		...
		self.lEditOrgCauliJan.insert(str(0))
		self.lEditOrgCauliFeb.insert(str(0))
		self.lEditOrgCauliMar.insert(str(0))
		self.lEditOrgCauliApr.insert(str(0))
		self.lEditOrgCauliMay.insert(str(0))
		self.lEditOrgCauliJun.insert(str(0))
		self.lEditOrgCauliJul.insert(str(0))
		self.lEditOrgCauliAug.insert(str(0))
		self.lEditOrgCauliSep.insert(str(0))
		self.lEditOrgCauliOct.insert(str(0))
		self.lEditOrgCauliNov.insert(str(0))
		self.lEditOrgCauliDec.insert(str(0))

		self.lEditConvCarrCrklJan.insert(str(0))
		self.lEditConvCarrCrklFeb.insert(str(0))
		self.lEditConvCarrCrklMar.insert(str(0))
		self.lEditConvCarrCrklApr.insert(str(0))
		self.lEditConvCarrCrklMay.insert(str(0))
		self.lEditConvCarrCrklJun.insert(str(0))
		self.lEditConvCarrCrklJul.insert(str(0))
		self.lEditConvCarrCrklAug.insert(str(0))
		self.lEditConvCarrCrklSep.insert(str(0))
		self.lEditConvCarrCrklOct.insert(str(0))
		self.lEditConvCarrCrklNov.insert(str(0))
		self.lEditConvCarrCrklDec.insert(str(0))

		self.lEditConvCarrDcdJan.insert(str(0))
		self.lEditConvCarrDcdFeb.insert(str(0))
		self.lEditConvCarrDcdMar.insert(str(0))
		self.lEditConvCarrDcdApr.insert(str(0))
		self.lEditConvCarrDcdMay.insert(str(0))
		self.lEditConvCarrDcdJun.insert(str(0))
		self.lEditConvCarrDcdJul.insert(str(0))
		self.lEditConvCarrDcdAug.insert(str(0))
		self.lEditConvCarrDcdSep.insert(str(0))
		self.lEditConvCarrDcdOct.insert(str(0))
		self.lEditConvCarrDcdNov.insert(str(0))
		self.lEditConvCarrDcdDec.insert(str(0))
		...
		self.lEditPeasJan.insert(str(0))
		self.lEditPeasFeb.insert(str(0))
		self.lEditPeasMar.insert(str(0))
		self.lEditPeasApr.insert(str(0))
		self.lEditPeasMay.insert(str(0))
		self.lEditPeasJun.insert(str(0))
		self.lEditPeasJul.insert(str(0))
		self.lEditPeasAug.insert(str(0))
		self.lEditPeasSep.insert(str(0))
		self.lEditPeasOct.insert(str(0))
		self.lEditPeasNov.insert(str(0))
		self.lEditPeasDec.insert(str(0))

		self.lEditPoblanoJan.insert(str(0))
		self.lEditPoblanoFeb.insert(str(0))
		self.lEditPoblanoMar.insert(str(0))
		self.lEditPoblanoApr.insert(str(0))
		self.lEditPoblanoMay.insert(str(0))
		self.lEditPoblanoJun.insert(str(0))
		self.lEditPoblanoJul.insert(str(0))
		self.lEditPoblanoAug.insert(str(0))
		self.lEditPoblanoSep.insert(str(0))
		self.lEditPoblanoOct.insert(str(0))
		self.lEditPoblanoNov.insert(str(0))
		self.lEditPoblanoDec.insert(str(0))

		self.lEditWCornJan.insert(str(0))
		self.lEditWCornFeb.insert(str(0))
		self.lEditWCornMar.insert(str(0))
		self.lEditWCornApr.insert(str(0))
		self.lEditWCornMay.insert(str(0))
		self.lEditWCornJun.insert(str(0))
		self.lEditWCornJul.insert(str(0))
		self.lEditWCornAug.insert(str(0))
		self.lEditWCornSep.insert(str(0))
		self.lEditWCornOct.insert(str(0))
		self.lEditWCornNov.insert(str(0))
		self.lEditWCornDec.insert(str(0))


		
		self.lEditTotalCornJan.insert(str(0))
		self.lEditTotalCornFeb.insert(str(0))
		self.lEditTotalCornMar.insert(str(0))
		self.lEditTotalCornApr.insert(str(0))
		self.lEditTotalCornMay.insert(str(0))
		self.lEditTotalCornJun.insert(str(0))
		self.lEditTotalCornJul.insert(str(0))
		self.lEditTotalCornAug.insert(str(0))
		self.lEditTotalCornSep.insert(str(0))
		self.lEditTotalCornOct.insert(str(0))
		self.lEditTotalCornNov.insert(str(0))
		self.lEditTotalCornDec.insert(str(0))

		self.lEditGreenBeansJan.insert(str(0))
		self.lEditGreenBeansFeb.insert(str(0))
		self.lEditGreenBeansMar.insert(str(0))
		self.lEditGreenBeansApr.insert(str(0))
		self.lEditGreenBeansMay.insert(str(0))
		self.lEditGreenBeansJun.insert(str(0))
		self.lEditGreenBeansJul.insert(str(0))
		self.lEditGreenBeansAug.insert(str(0))
		self.lEditGreenBeansSep.insert(str(0))
		self.lEditGreenBeansOct.insert(str(0))
		self.lEditGreenBeansNov.insert(str(0))
		self.lEditGreenBeansDec.insert(str(0))

		self.lEditMushJan.insert(str(0))
		self.lEditMushFeb.insert(str(0))
		self.lEditMushMar.insert(str(0))
		self.lEditMushApr.insert(str(0))
		self.lEditMushMay.insert(str(0))
		self.lEditMushJun.insert(str(0))
		self.lEditMushJul.insert(str(0))
		self.lEditMushAug.insert(str(0))
		self.lEditMushSep.insert(str(0))
		self.lEditMushOct.insert(str(0))
		self.lEditMushNov.insert(str(0))
		self.lEditMushDec.insert(str(0))

		self.lEditOnionJan.insert(str(0))
		self.lEditOnionFeb.insert(str(0))
		self.lEditOnionMar.insert(str(0))
		self.lEditOnionApr.insert(str(0))
		self.lEditOnionMay.insert(str(0))
		self.lEditOnionJun.insert(str(0))
		self.lEditOnionJul.insert(str(0))
		self.lEditOnionAug.insert(str(0))
		self.lEditOnionSep.insert(str(0))
		self.lEditOnionOct.insert(str(0))
		self.lEditOnionNov.insert(str(0))
		self.lEditOnionDec.insert(str(0))

		self.lEditPotatoesJan.insert(str(0))
		self.lEditPotatoesFeb.insert(str(0))
		self.lEditPotatoesMar.insert(str(0))
		self.lEditPotatoesApr.insert(str(0))
		self.lEditPotatoesMay.insert(str(0))
		self.lEditPotatoesJun.insert(str(0))
		self.lEditPotatoesJul.insert(str(0))
		self.lEditPotatoesAug.insert(str(0))
		self.lEditPotatoesSep.insert(str(0))
		self.lEditPotatoesOct.insert(str(0))
		self.lEditPotatoesNov.insert(str(0))
		self.lEditPotatoesDec.insert(str(0))

		self.lEditRedPepperJan.insert(str(0))
		self.lEditRedPepperFeb.insert(str(0))
		self.lEditRedPepperMar.insert(str(0))
		self.lEditRedPepperApr.insert(str(0))
		self.lEditRedPepperMay.insert(str(0))
		self.lEditRedPepperJun.insert(str(0))
		self.lEditRedPepperJul.insert(str(0))
		self.lEditRedPepperAug.insert(str(0))
		self.lEditRedPepperSep.insert(str(0))
		self.lEditRedPepperOct.insert(str(0))
		self.lEditRedPepperNov.insert(str(0))
		self.lEditRedPepperDec.insert(str(0))

		self.lEditSnowPeasJan.insert(str(0))
		self.lEditSnowPeasFeb.insert(str(0))
		self.lEditSnowPeasMar.insert(str(0))
		self.lEditSnowPeasApr.insert(str(0))
		self.lEditSnowPeasMay.insert(str(0))
		self.lEditSnowPeasJun.insert(str(0))
		self.lEditSnowPeasJul.insert(str(0))
		self.lEditSnowPeasAug.insert(str(0))
		self.lEditSnowPeasSep.insert(str(0))
		self.lEditSnowPeasOct.insert(str(0))
		self.lEditSnowPeasNov.insert(str(0))
		self.lEditSnowPeasDec.insert(str(0))

		self.lEditSpinachJan.insert(str(0))
		self.lEditSpinachFeb.insert(str(0))
		self.lEditSpinachMar.insert(str(0))
		self.lEditSpinachApr.insert(str(0))
		self.lEditSpinachMay.insert(str(0))
		self.lEditSpinachJun.insert(str(0))
		self.lEditSpinachJul.insert(str(0))
		self.lEditSpinachAug.insert(str(0))
		self.lEditSpinachSep.insert(str(0))
		self.lEditSpinachOct.insert(str(0))
		self.lEditSpinachNov.insert(str(0))
		self.lEditSpinachDec.insert(str(0))

		self.lEditWCNJan.insert(str(0))
		self.lEditWCNFeb.insert(str(0))
		self.lEditWCNMar.insert(str(0))
		self.lEditWCNApr.insert(str(0))
		self.lEditWCNMay.insert(str(0))
		self.lEditWCNJun.insert(str(0))
		self.lEditWCNJul.insert(str(0))
		self.lEditWCNAug.insert(str(0))
		self.lEditWCNSep.insert(str(0))
		self.lEditWCNOct.insert(str(0))
		self.lEditWCNNov.insert(str(0))
		self.lEditWCNDec.insert(str(0))

		self.lEditOthersJan.insert(str(0))
		self.lEditOthersFeb.insert(str(0))
		self.lEditOthersMar.insert(str(0))
		self.lEditOthersApr.insert(str(0))
		self.lEditOthersMay.insert(str(0))
		self.lEditOthersJun.insert(str(0))
		self.lEditOthersJul.insert(str(0))
		self.lEditOthersAug.insert(str(0))
		self.lEditOthersSep.insert(str(0))
		self.lEditOthersOct.insert(str(0))
		self.lEditOthersNov.insert(str(0))
		self.lEditOthersDec.insert(str(0))
