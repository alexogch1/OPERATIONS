...
form_class = uic.loadUiType("domestic purchases2.ui")[0]
...
class MyWindowClass(QtWidgets.QDialog, form_class):
	...
	def read_data_from_file(self, year):	
			...
			dict_prod = {'Diced Red Pper': list(datos['Diced Red Pper'])}
			dict_prod2 = {'Strips Red Pper': list(datos['Strips Red Pper'])}
			dict_prod3 = {'Corn Kernels': list(datos['Corn Kernels'])}
			dict_prod4 = {'Organic Broccoli Florets': list(datos['Organic Broccoli Florets'])}
			dict_prod5 = {'prod5': list(datos['prod5'])}
			dict_prod6 = {'prod6': list(datos['prod6'])}
			dict_prod7 = {'prod7': list(datos['prod7'])}
			dict_prod8 = {'prod8': list(datos['prod8'])}
			dict_prod9 = {'prod9': list(datos['prod9'])}
			dict_prod10 = {'prod10': list(datos['prod10'])}

			Dict_Final = {}
			Dict_Final['Diced Red Pper'] = list(datos['Diced Red Pper'])
			Dict_Final['Strips Red Pper'] = list(datos['Strips Red Pper'])
			Dict_Final['Corn Kernels'] = list(datos['Corn Kernels'])
			Dict_Final['Organic Broccoli Florets'] = list(datos['Organic Broccoli Florets'])
			Dict_Final['prod5'] = list(datos['prod5'])
			Dict_Final['prod6'] = list(datos['prod6'])
			Dict_Final['prod7'] = list(datos['prod7'])
			Dict_Final['prod8'] = list(datos['prod8'])
	...
	def update_totals(self):
		...
		dict_prod2 = {}
		dict_prod2['Strips Red Pper'] = list([
		...
		dict_prod4 = {}
		dict_prod4['Organic Broccoli Florets'] = list([
		...
		dict_total_Domestic_Purchases['total Domestic Purchases'] = list([
			np_total_Jan, np_total_Feb, np_total_Mar, 
			np_total_Apr, np_total_May, np_total_Jun, 
			np_total_Jul, np_total_Aug, np_total_Sep, 
			np_total_Oct, np_total_Nov, np_total_Dec])
		print('diccionario de compras totales', dict_total_Domestic_Purchases)
	...
	def inicializar_campós(self,datos):
		...
		prod = datos.get('Diced Red Pper')
		print('impresion de Diced Red Pper Diccionario',prod)
		self.lEditJanProd.insert(str(prod[0]))
		...
		prod2 = datos.get('Strips Red Pper')
		print('impresion de Strips Red Pper Diccionario',prod2)
		...
		prod3 = datos.get('Corn Kernels')
		print('impresion de Corn Kernels Diccionario',prod3)
		...
		prod4 = datos.get('Organic Broccoli Florets')
		print('impresion de Organic Broccoli Florets',prod4)
		...
		prod5 = datos.get('prod5')
		print('impresion de prod5',prod5)				
		...
		prod6 = datos.get('prod6')
		print('impresion de prod6',prod6)				
		...
		prod7 = datos.get('prod7')
		print('impresion de prod7',prod7)										
		...
		prod8 = datos.get('prod8')
		print('impresion de prod8',prod8)										
		...
		print('impresion de prod9',prod9)										
		...
		print('impresion de prod10',prod10)										
	...
	def genera_excel(self,datos):
		import report_domesticpurchases_xls
		genera_reporte = report_domesticpurchases_xls
