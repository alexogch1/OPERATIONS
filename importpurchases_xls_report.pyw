...
form_class = uic.loadUiType("Import_purchases2.ui")[0]
...
class MyWindowClass(QtWidgets.QDialog, form_class):
	...
	def read_data_from_file(self, year):	
			...
			dict_prod = {'BRUSSEL SPR': list(datos['BRUSSEL SPR'])}
			dict_prod2 = {'CRKLE CARR CONV': list(datos['CRKLE CARR CONV'])}
			dict_prod3 = {'BABY ORG CARR': list(datos['BABY ORG CARR'])}
			dict_prod4 = {'YLLW ORG CARR': list(datos['YLLW ORG CARR'])}
			dict_prod5 = {'YLLW BIAS CARR': list(datos['YLLW BIAS CARR'])}
			dict_prod6 = {'GRN BEANS': list(datos['GRN BEANS'])}
			dict_prod7 = {'SLAB GR BEANS': list(datos['SLAB GR BEANS'])}
			dict_prod8 = {'SUGAR SNAP P': list(datos['SUGAR SNAP P'])}
			dict_prod9 = {'BROC FLTS': list(datos['BROC FLTS'])}
			dict_prod10 = {'ORG JUL. CARR': list(datos['ORG JUL. CARR'])}
			dict_prod11 = {'STRPS GR PEPPER': list(datos['STRPS GR PEPPER'])}
			dict_prod12 = {'ONION': list(datos['ONION'])}
			dict_prod13 = {'MUSHROOM': list(datos['MUSHROOM'])}
			dict_prod14 = {'CELERY': list(datos['CELERY'])}
			dict_prod15 = {'WATER CH NUTS': list(datos['WATER CH NUTS'])}
			dict_prod16 = {'CORN WHOLE': list(datos['CORN WHOLE'])}
			dict_prod17 = {'CORN KERNELS': list(datos['CORN KERNELS'])}
			dict_prod18 = {'GARBANZO': list(datos['GARBANZO'])}
			dict_prod19 = {'GREEN PEPPER': list(datos['GREEN PEPPER'])}
			dict_prod20 = {'KIDNEY BEANS': list(datos['KIDNEY BEANS'])}
			dict_prod21 = {'NAVY BEANS': list(datos['NAVY BEANS'])}
			dict_prod22 = {'RED PEPPER': list(datos['RED PEPPER'])}
			dict_prod23 = {'GREEN PEAS': list(datos['GREEN PEAS'])}
			dict_prod24 = {'ITALIAN GR BEANS': list(datos['ITALIAN GR BEANS'])}
			dict_prod25 = {'DCED POTATOES': list(datos['DCED POTATOES'])}
			dict_prod26 = {'LIMA BEANS': list(datos['LIMA BEANS'])}
			dict_prod27 = {'CUT GR BEANS': list(datos['CUT GR BEANS'])}
			dict_prod28 = {'BROC CUTS': list(datos['BROC CUTS'])}
			dict_prod29 = {'SNOW PEAS': list(datos['SNOW PEAS'])}
			dict_prod30 = {'PARIS CARR': list(datos['PARIS CARR'])}
			...
			Dict_Final = {}
			Dict_Final['BRUSSEL SPR'] = list(datos['BRUSSEL SPR'])
			Dict_Final['CRKLE CARR CONV'] = list(datos['CRKLE CARR CONV'])
			Dict_Final['BABY ORG CARR'] = list(datos['BABY ORG CARR'])
			Dict_Final['YLLW ORG CARR'] = list(datos['YLLW ORG CARR'])
			Dict_Final['YLLW BIAS CARR'] = list(datos['YLLW BIAS CARR'])
			Dict_Final['GRN BEANS'] = list(datos['GRN BEANS'])
			Dict_Final['SLAB GR BEANS'] = list(datos['SLAB GR BEANS'])
			Dict_Final['SUGAR SNAP P'] = list(datos['SUGAR SNAP P'])
			Dict_Final['BROC FLTS'] = list(datos['BROC FLTS'])
			Dict_Final['ORG JUL. CARR'] = list(datos['ORG JUL. CARR'])
			Dict_Final['STRPS GR PEPPER'] = list(datos['STRPS GR PEPPER'])
			Dict_Final['CELERY'] = list(datos['CELERY'])
			Dict_Final['ONION'] = list(datos['ONION'])
			Dict_Final['MUSHROOM'] = list(datos['MUSHROOM'])
			Dict_Final['WATER CH NUTS'] = list(datos['WATER CH NUTS'])
			Dict_Final['CORN WHOLE'] = list(datos['CORN WHOLE'])
			Dict_Final['CORN KERNELS'] = list(datos['CORN KERNELS'])
			Dict_Final['GARBANZO'] = list(datos['GARBANZO'])
			Dict_Final['GREEN PEPPER'] = list(datos['GREEN PEPPER'])
			Dict_Final['KIDNEY BEANS'] = list(datos['KIDNEY BEANS'])
			Dict_Final['NAVY BEANS'] = list(datos['NAVY BEANS'])
			Dict_Final['RED PEPPER'] = list(datos['RED PEPPER'])
			Dict_Final['GREEN PEAS'] = list(datos['GREEN PEAS'])
			Dict_Final['ITALIAN GR BEANS'] = list(datos['ITALIAN GR BEANS'])
			Dict_Final['DCED POTATOES'] = list(datos['DCED POTATOES'])
			Dict_Final['LIMA BEANS'] = list(datos['LIMA BEANS'])
			Dict_Final['CUT GR BEANS'] = list(datos['CUT GR BEANS'])
			Dict_Final['BROC CUTS'] = list(datos['BROC CUTS'])
			Dict_Final['SNOW PEAS'] = list(datos['SNOW PEAS'])
			Dict_Final['PARIS CARR'] = list(datos['PARIS CARR'])
	...
	def update_totals(self):
		...
		dict_prod2 = {}
		dict_prod2['CRKLE CARR CONV'] = list([
		...
		dict_prod5 = {}
		dict_prod5['YLLW BIAS CARR'] = list([
		...
		dict_prod11 = {}
		dict_prod11['STRPS GR PEPPER'] = list([
		...
		dict_prod15 = {}
		dict_prod15['WATER CH NUTS'] = list([
		...
		dict_prod24 = {}
		dict_prod24['ITALIAN GR BEANS'] = list([
		...
		dict_prod25 = {}
		dict_prod25['DCED POTATOES'] = list([
		...
		dict_total_Import_Purchases = {}
		dict_total_Import_Purchases['total Import Purchases'] = list([
			np_total_Jan, np_total_Feb, np_total_Mar, 
			np_total_Apr, np_total_May, np_total_Jun, 
			np_total_Jul, np_total_Aug, np_total_Sep, 
			np_total_Oct, np_total_Nov, np_total_Dec])
		print('diccionario de compras Importacion totales', dict_total_Import_Purchases)
	...
	def inicializar_campós(self,datos):
		...
		prod2 = datos.get('CRKLE CARR CONV')
		...
		prod5 = datos.get('YLLW BIAS CARR')
		...
		prod11 = datos.get('STRPS GR PEPPER')
		...
		prod15 = datos.get('WATER CH NUTS')
		...
		prod24 = datos.get('ITALIAN GR BEANS')
		...
		prod25 = datos.get('DCED POTATOES')
	...
	def genera_excel(self,datos):
		import report_importpurchases_xls
		genera_reporte = report_importpurchases_xls
