...
"""
In this module it is input the data of Ingredients Inventories
"""
...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		list_ingredients = [ 'CELERY', 'ONION STRIPS', 'CHINESE PEAS', 'PEAS', 'SUGAR SNAP P',
		...
		self.setupUi(self)
		self.Title.setText(str('MB MEX INGREDIENTS INVENTORIES'))
		...
		self.table = 'inventoriesingredients'
		self.lock_fields()
