...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		list_ingredients = ['F Spears','F Flrts Conv', 'F Crowns' ,'F Flrts Org', 'F Stalks Conv', 
		...
		self.setupUi(self)
		self.Title.setText(str('MB MEX BROCC INVENTORIES'))
		...
		self.table = 'inventoriesbroccoli'
		self.lock_fields()
