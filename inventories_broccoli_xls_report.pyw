...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		self.Title.setText(str('BROCCOLI INVENTORIES'))
	...
	def read_data_from_file(self, year):	
			...
			dict_prod = {'F Spears': list(datos['F Spears'])}
			dict_prod2 = {'F Flrts Conv': list(datos['F Flrts Conv'])}
			dict_prod3 = {'F Crowns': list(datos['F Crowns'])}
			dict_prod4 = {'F Flrts Org': list(datos['F Flrts Org'])}
			dict_prod5 = {'F Stalks Conv': list(datos['F Stalks Conv'])}
			dict_prod6 = {'F Stalks Org': list(datos['F Stalks Org'])}
			dict_prod7 = {'F Chopped': list(datos['F Chopped'])}
			dict_prod8 = {'F Sori Pearls': list(datos['F Sori Pearls'])}
			dict_prod9 = {'F Cuts': list(datos['F Cuts'])}
			dict_prod10 = {'F Cuts Org': list(datos['F Cuts Org'])}
			...
			dict_prod19 = {'P Spears': list(datos['P Spears'])}
			dict_prod20 = {'P Florets': list(datos['P Florets'])}
			dict_prod21 = {'P Crowns': list(datos['P Crowns'])}
			dict_prod22 = {'P Flrts Org': list(datos['P Flrts Org'])}
			dict_prod23 = {'P Stalks Conv': list(datos['P Stalks Conv'])}
			dict_prod24 = {'P Stalks Org': list(datos['P Stalks Org'])}
			dict_prod25 = {'P Chopped': list(datos['P Chopped'])}
			dict_prod26 = {'P Sori Pearls': list(datos['P Sori Pearls'])}
			dict_prod27 = {'P Cuts Conv': list(datos['P Cuts Conv'])}
			dict_prod28 = {'P Cuts Org': list(datos['P Cuts Org'])}
			...
			Dict_Final = {}
			Dict_Final['F Spears'] = list(datos['F Spears'])
			Dict_Final['F Flrts Conv'] = list(datos['F Flrts Conv'])
			Dict_Final['F Crowns'] = list(datos['F Crowns'])
			Dict_Final['F Flrts Org'] = list(datos['F Flrts Org'])
			Dict_Final['F Stalks Conv'] = list(datos['F Stalks Conv'])
			Dict_Final['F Stalks Org'] = list(datos['F Stalks Org'])
			Dict_Final['F Chopped'] = list(datos['F Chopped'])
			Dict_Final['F Sori Pearls'] = list(datos['F Sori Pearls'])
			Dict_Final['F Cuts'] = list(datos['F Cuts'])
			Dict_Final['F Cuts Org'] = list(datos['F Cuts Org'])
			...
			Dict_Final['P Spears'] = list(datos['P Spears'])
			Dict_Final['P Florets'] = list(datos['P Florets'])
			Dict_Final['P Crowns'] = list(datos['P Crowns'])
			Dict_Final['P Flrts Org'] = list(datos['P Flrts Org'])
			Dict_Final['P Stalks Conv'] = list(datos['P Stalks Conv'])
			Dict_Final['P Stalks Org'] = list(datos['P Stalks Org'])
			Dict_Final['P Chopped'] = list(datos['P Chopped'])
			Dict_Final['P Sori Pearls'] = list(datos['P Sori Pearls'])
			Dict_Final['P Cuts Conv'] = list(datos['P Cuts Conv'])
			Dict_Final['P Cuts Org'] = list(datos['P Cuts Org'])
	...
	def update_totals(self):
		...
		dict_prod23 = {}
		dict_prod23['P Stalks Conv'] = list([
		...
		dict_prod26 = {}
		dict_prod26['P Sori Pearls'] = list([
		...
		dict_total_inventories_Broccoli = {}
		dict_total_inventories_Broccoli['total Inventories'] = list([
			np_total_Jan, np_total_Feb, np_total_Mar, 
			np_total_Apr, np_total_May, np_total_Jun, 
			np_total_Jul, np_total_Aug, np_total_Sep, 
			np_total_Oct, np_total_Nov, np_total_Dec])
		print('diccionario de Broccoli Inventories', dict_total_inventories_Broccoli)
	...
	def inicializar_campós(self,datos):
		...
		prod23 = datos.get('P Stalks Conv')
		...
		prod26 = datos.get('P Sori Pearls')
	...
	def genera_excel(self,datos):
		import inventories_broccoli_xls_report_generator
		genera_reporte = inventories_broccoli_xls_report_generator
