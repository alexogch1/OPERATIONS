...
"""
In this module is generated the report of Broccoli Inventories
"""
...
class XLS():
    ...
    def genera_reporte(self,datos):
        ...
        self.sheet1 = self.book.add_sheet('BROCC INVENTORIES')          # Crea las columnas con los datos correspondientes
    ...
    def main_body_sht(self,hoja):
        ...
        np_Total_broccoli_Finished = np_group1 + np_group2 
        print(np_Total_broccoli_Finished)
        Total_broccoli_Finished  = np_Total_broccoli_Finished.tolist()
        print('Total Broccoli Finished ', Total_broccoli_Finished[0])
        dict_total_broccoli_Finished = {}
        dict_total_broccoli_Finished['total Broccoli Finished'] = Total_broccoli_Finished[0] 
        print(dict_total_broccoli_Finished)
        values = list(dict_total_broccoli_Finished.values())
        producto = list(dict_total_broccoli_Finished.keys()) 
        np_Total_broccInventories_finished = np.array(values)
        acum = np_Total_broccInventories_finished.sum()
        columna = 12
        renglon = 7
        self.ingresa_datos(hoja,columna,renglon,producto,values, acum )


        np_group3 = np_prod19 + np_prod20 + np_prod21 + np_prod22 + np_prod23 
        np_group4 = np_prod24+ np_prod25 + np_prod26 + np_prod27 + np_prod28
        
        
        np_Total_broccoli_Process = np_group3 + np_group4
        print(np_Total_broccoli_Process)
        Total_broccoli_Process  = np_Total_broccoli_Process.tolist()
        print('Total Broccoli Process ', Total_broccoli_Process[0])
        dict_total_broccoli_Process = {}
        dict_total_broccoli_Process['total Broccoli In Process'] = Total_broccoli_Process[0] 
        print(dict_total_broccoli_Process)
        values = list(dict_total_broccoli_Process.values())
        producto = list(dict_total_broccoli_Process.keys()) 
        np_Total_broccInventories_Process = np.array(values)
        acum = np_Total_broccInventories_Process.sum()
        columna = 12
        renglon = 30
        self.ingresa_datos(hoja,columna,renglon,producto,values, acum )


        np_brocco_inventories_total = np_Total_broccInventories_finished + np_Total_broccInventories_Process
        print(np_brocco_inventories_total)

        
        Total_broccoli  = np_brocco_inventories_total.tolist()
        print('Total Broccoli  ', Total_broccoli[0])
        dict_total_broccoli = {}
        dict_total_broccoli['total Broccoli'] = Total_broccoli[0] 
        print(dict_total_broccoli)
        values = list(dict_total_broccoli.values())
        producto = list(dict_total_broccoli.keys()) 
        np_Total_broccInventories = np.array(values)
        acum = np_Total_broccInventories.sum()
        columna = 13
        renglon = 30
        self.ingresa_datos(hoja,columna,renglon,producto,values, acum )

        np_Conv1 = np_prod + np_prod2 + np_prod3 + np_prod5 + np_prod7
        np_Conv2 = np_prod8 + np_prod9 +np_prod19 +np_prod20 + np_prod21
        np_Conv3 = np_prod23 + np_prod25 + np_prod26 + np_prod27

        np_conv = np_Conv1 + np_Conv2 + np_Conv3
        np_Org  = np_prod4 + np_prod6 + np_prod10 + np_prod22 + np_prod24 + np_prod28
        
        
       
        np_Conv_Finished = np_prod + np_prod2 + np_prod3 + np_prod5 + np_prod7 + np_prod8 + np_prod9
        np_Conv_Process =  np_prod19 +np_prod20 + np_prod21 + np_prod23 + np_prod25 + np_prod26 + np_prod27

        np_conv = np_Conv_Finished + np_Conv_Process
        
        np_Org_Finished = np_prod4 + np_prod6 + np_prod10 
        np_Org_Process = np_prod22 + np_prod24 + np_prod28
        np_org = np_Org_Finished + np_Org_Process

        
        Total_Conventional_Finished  = np_Conv_Finished.tolist()
        print('total Conventional Finished',Total_Conventional_Finished[0])
        dict_Total_Conventional_Finished = {}
        dict_Total_Conventional_Finished ['Total Conv Finished'] = Total_Conventional_Finished[0]
        values = list(dict_Total_Conventional_Finished.values())
        producto = list(dict_Total_Conventional_Finished.keys())
        np_Total_ConventionalFinished = np.array(values)
        acum = np_Total_ConventionalFinished.sum()
        columna = 14
        renglon = 7
        self.ingresa_datos(hoja,columna,renglon,producto,values, acum )


        Total_Conventional_Process  = np_Conv_Process.tolist()
        print('total Conventional Process',Total_Conventional_Process[0])
        dict_Total_Conventional_Process = {}
        dict_Total_Conventional_Process ['Total Conv Process'] = Total_Conventional_Process[0]
        values = list(dict_Total_Conventional_Process.values())
        producto = list(dict_Total_Conventional_Process.keys())
        np_Total_ConventionalProcess = np.array(values)
        acum = np_Total_ConventionalProcess.sum()
        columna = 14
        renglon = 30
        self.ingresa_datos(hoja,columna,renglon,producto,values, acum )


        Total_Organic_Finished  = np_Org_Finished.tolist()
        print('total Organic Finished',Total_Organic_Finished[0])
        dict_Total_Organic_Finished = {}
        dict_Total_Organic_Finished ['Total Org Finished'] = Total_Organic_Finished[0]
        values = list(dict_Total_Organic_Finished.values())
        producto = list(dict_Total_Organic_Finished.keys())
        np_Total_OrganicFinished = np.array(values)
        acum = np_Total_OrganicFinished.sum()
        columna = 15
        renglon = 7
        self.ingresa_datos(hoja,columna,renglon,producto,values, acum )


        Total_Organic_Process  = np_Org_Process.tolist()
        print('total Organic Process',Total_Organic_Process[0])
        dict_Total_Organic_Process = {}
        dict_Total_Organic_Process ['Total Org Process'] = Total_Organic_Process[0]
        values = list(dict_Total_Organic_Process.values())
        producto = list(dict_Total_Organic_Process.keys())
        np_Total_OrganicProcess = np.array(values)
        acum = np_Total_OrganicProcess.sum()
        columna = 15
        renglon = 30
        self.ingresa_datos(hoja,columna,renglon,producto,values, acum )
        ...
        dict_Total_Organic = {}
        dict_Total_Organic ['Total Org Broccoli '] = Total_Organic[0]
        ...
        dict_Total_Conventional ['Total Conv Broccoli '] = Total_Conventional[0]
