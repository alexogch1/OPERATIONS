...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		self.Title.setText(str('CARROTS INVENTORIES'))
	...
	def read_data_from_file(self, year):	
			...
			dict_prod = {'Crkle Markon': list(datos['Crkle Markon'])}
			dict_prod2 = {'Crkle small/med': list(datos['Crkle small/med'])}
			dict_prod3 = {'Crkle P. Ch.': list(datos['Crkle P. Ch.'])}
			dict_prod4 = {'Crkle Org': list(datos['Crkle Org'])}
			dict_prod5 = {'Juliene Conv.': list(datos['Juliene Conv.'])}
			dict_prod6 = {'Julinene Org': list(datos['Julinene Org'])}
			dict_prod7 = {'Bias Smooth Oran': list(datos['Bias Smooth Oran'])}
			dict_prod8 = {'Smooth Slices': list(datos['Smooth Slices'])}
			dict_prod9 = {'Baby Conv': list(datos['Baby Conv'])}
			dict_prod10 = {'Baby Org': list(datos['Baby Org'])}
			dict_prod11 = {'Bias Yllow Org': list(datos['Bias Yllow Org'])}
			dict_prod12 = {'Bias Yllow Conv': list(datos['Bias Yllow Conv'])}
			dict_prod13 = {'Diced': list(datos['Diced'])}
			dict_prod14 = {'Shoestring': list(datos['Shoestring'])}
			dict_prod15 = {'Parisian': list(datos['Parisian'])}
			dict_prod16 = {'Finished': list(datos['Finished'])}
			...
			Dict_Final = {}
			Dict_Final['Crkle Markon'] = list(datos['Crkle Markon'])
			Dict_Final['Crkle small/med'] = list(datos['Crkle small/med'])
			Dict_Final['Crkle P. Ch.'] = list(datos['Crkle P. Ch.'])
			Dict_Final['Crkle Org'] = list(datos['Crkle Org'])
			Dict_Final['Juliene Conv.'] = list(datos['Juliene Conv.'])
			Dict_Final['Julinene Org'] = list(datos['Julinene Org'])
			Dict_Final['Bias Smooth Oran'] = list(datos['Bias Smooth Oran'])
			Dict_Final['Smooth Slices'] = list(datos['Smooth Slices'])
			Dict_Final['Baby Conv'] = list(datos['Baby Conv'])
			Dict_Final['Baby Org'] = list(datos['Baby Org'])
			Dict_Final['Bias Yllow Org'] = list(datos['Bias Yllow Org'])
			Dict_Final['Bias Yllow Conv'] = list(datos['Bias Yllow Conv'])
			Dict_Final['Diced'] = list(datos['Diced'])
			Dict_Final['Shoestring'] = list(datos['Shoestring'])
			Dict_Final['Parisian'] = list(datos['Parisian'])
			Dict_Final['Finished'] = list(datos['Finished'])
	...
	def update_totals(self):
		...
		dict_prod2 = {}
		dict_prod2['Crkle small/med'] = list([
		...
		dict_prod7 = {}
		dict_prod7['Bias Smooth Oran'] = list([
		...
		dict_prod11 = {}
		dict_prod11['Bias Yllow Org'] = list([
		...
		dict_prod12 = {}
		dict_prod12['Bias Yllow Conv'] = list([
		...
		dict_total_inventories_Carrots = {}
		dict_total_inventories_Carrots['total Inventories'] = list([
			np_total_Jan, np_total_Feb, np_total_Mar, 
			np_total_Apr, np_total_May, np_total_Jun, 
			np_total_Jul, np_total_Aug, np_total_Sep, 
			np_total_Oct, np_total_Nov, np_total_Dec])
		print('diccionario de Carrots Inventories', dict_total_inventories_Carrots)
	...
	def inicializar_campós(self,datos):
		...
		prod2 = datos.get('Crkle small/med')
		...
		prod7 = datos.get('Bias Smooth Oran')
		...
		prod11 = datos.get('Bias Yllow Org')
		...
		prod12 = datos.get('Bias Yllow Conv')
	...
	def genera_excel(self,datos):
		import inventories_carrots_xls_report_generator
		genera_reporte = inventories_carrots_xls_report_generator
