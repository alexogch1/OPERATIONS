...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		self.Title.setText(str('CAULIFLOWER INVENTORIES'))
	...
	def read_data_from_file(self, year):	
			...
			dict_prod = {'Japan': list(datos['Japan'])}
			dict_prod2 = {'1 1/2" - 2"': list(datos['1 1/2" - 2"'])}
			dict_prod3 = {'1 1/4"-1 3/4"': list(datos['1 1/4"-1 3/4"'])}
			dict_prod4 = {'1" - 2"': list(datos['1" - 2"'])}
			dict_prod5 = {'3/4"-1 1/2"': list(datos['3/4"-1 1/2"'])}
			dict_prod6 = {'3/4"-1 3/8"': list(datos['3/4"-1 3/8"'])}
			dict_prod7 = {'3/4"-1 1/4"': list(datos['3/4"-1 1/4"'])}
			dict_prod8 = {'IZ PREMIUM': list(datos['IZ PREMIUM'])}
			dict_prod9 = {'RICED CONV.': list(datos['RICED CONV.'])}
			dict_prod10 = {'RICED ORG.': list(datos['RICED ORG.'])}
			dict_prod11 = {'ORGANIC': list(datos['ORGANIC'])}
			dict_prod12 = {'WET PACK': list(datos['WET PACK'])}
			dict_prod13 = {'NUGGETS': list(datos['NUGGETS'])}
			dict_prod14 = {'OTHERS': list(datos['OTHERS'])}
			dict_prod15 = {'LA HUERTA': list(datos['LA HUERTA'])}
			...
			Dict_Final = {}
			Dict_Final['Japan'] = list(datos['Japan'])
			Dict_Final['1 1/2" - 2"'] = list(datos['1 1/2" - 2"'])
			Dict_Final['1 1/4"-1 3/4"'] = list(datos['1 1/4"-1 3/4"'])
			Dict_Final['1" - 2"'] = list(datos['1" - 2"'])
			Dict_Final['3/4"-1 1/2"'] = list(datos['3/4"-1 1/2"'])
			Dict_Final['3/4"-1 3/8"'] = list(datos['3/4"-1 3/8"'])
			Dict_Final['3/4"-1 1/4"'] = list(datos['3/4"-1 1/4"'])
			Dict_Final['IZ PREMIUM'] = list(datos['IZ PREMIUM'])
			Dict_Final['RICED CONV.'] = list(datos['RICED CONV.'])
			Dict_Final['RICED ORG.'] = list(datos['RICED ORG.'])

			Dict_Final['ORGANIC'] = list(datos['ORGANIC'])
			Dict_Final['WET PACK'] = list(datos['WET PACK'])
			Dict_Final['NUGGETS'] = list(datos['NUGGETS'])
			Dict_Final['OTHERS'] = list(datos['OTHERS'])
			Dict_Final['LA HUERTA'] = list(datos['LA HUERTA'])
	...
	def update_totals(self):
		...
		dict_total_inventories_Cauliflower = {}
		dict_total_inventories_Cauliflower['total Inventories'] = list([
			np_total_Jan, np_total_Feb, np_total_Mar, 
			np_total_Apr, np_total_May, np_total_Jun, 
			np_total_Jul, np_total_Aug, np_total_Sep, 
			np_total_Oct, np_total_Nov, np_total_Dec])
		print('diccionario de Cauliflower Inventories', dict_total_inventories_Cauliflower)
	...
	def genera_excel(self,datos):
		import inventories_cauliflower_xls_report_generator
		genera_reporte = inventories_cauliflower_xls_report_generator
