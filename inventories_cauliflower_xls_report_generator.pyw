...
"""
In this module is generated the report of Cauliflower Inventories
"""
...
class XLS():
    ...
    def header(self, hoja, rows): # Coloca los titulos principales en la hoja de calculo)
        ...
        title3 = 'CAULIFLOWER INVENTORIES'
        rows = rows
        hoja = hoja
    ...
    def main_body_sht(self,hoja):
        ...
        np_caulif_inventories_total = np_group1+ np_group2 + np_group3
        print(np_caulif_inventories_total)

        
        Total_cauliflower  = np_caulif_inventories_total.tolist()
        ...
        np_Conv1 = np_prod + np_prod2 + np_prod3 + np_prod4 + np_prod5
        np_Conv2 = np_prod6 + np_prod7 +np_prod8 +np_prod9 
        np_Conv3 = np_prod12 + np_prod13 + np_prod14 + np_prod15

        np_conv = np_Conv1 + np_Conv2 + np_Conv3
        np_Org  = np_prod10 + np_prod11 
        ...
        dict_Total_Organic = {}
        dict_Total_Organic ['Total Org Cauliflower '] = Total_Organic[0]
        ...
        dict_Total_Conventional ['Total Conv Cauliflower '] = Total_Conventional[0]
    ...
    def save_sheet(self):
        name = "cauliflower inventories.xls"
        try:
            self.book.save(name)
