...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		list_ingredients = [ 'CELERY', 'ONION STRIPS', 'CHINESE PEAS', 'PEAS', 'SUGAR SNAP P',
							...
							'ITALIAN G BEANS', 'LIMA BEANS', 'CUT GREEN BEANS', 'MUSHROOMS', 'RED PEPPER DCD',
							 'RED PEPPER ST', 'POBALNO ST', 'POTATOE DCD', 'WATER C NUTS', 'KIDNEY BEANS', 
		...
		self.Title.setText(str('IINGREDIENTS INVENTORIES'))
	...
	def read_data_from_file(self, year):	
			...
			dict_prod = {'CELERY': list(datos['CELERY'])}
			dict_prod2 = {'ONION STRIPS': list(datos['ONION STRIPS'])}
			dict_prod3 = {'CHINESE PEAS': list(datos['CHINESE PEAS'])}
			dict_prod4 = {'PEAS': list(datos['PEAS'])}
			dict_prod5 = {'SUGAR SNAP P': list(datos['SUGAR SNAP P'])}
			dict_prod6 = {'CORN WHOLE': list(datos['CORN WHOLE'])}
			dict_prod7 = {'CORN GRAINS': list(datos['CORN GRAINS'])}
			dict_prod8 = {'FRENCH CUT G BEANS': list(datos['FRENCH CUT G BEANS'])}
			dict_prod9 = {'SLAB CUT G BEANS': list(datos['SLAB CUT G BEANS'])}
			dict_prod10 = {'WHOLE G BEANS': list(datos['WHOLE G BEANS'])}
			dict_prod11 = {'ITALIAN G BEANS': list(datos['ITALIAN G BEANS'])}
			dict_prod12 = {'LIMA BEANS': list(datos['LIMA BEANS'])}
			dict_prod13 = {'CUT GREEN BEANS': list(datos['CUT GREEN BEANS'])}
			dict_prod14 = {'MUSHROOMS': list(datos['MUSHROOMS'])}
			dict_prod15 = {'RED PEPPER DCD': list(datos['RED PEPPER DCD'])}
			dict_prod16 = {'RED PEPPER ST': list(datos['RED PEPPER ST'])}
			dict_prod17 = {'POBLANO ST': list(datos['POBLANO ST'])}
			dict_prod18 = {'POTATOE DCD': list(datos['POTATOE DCD'])}
			dict_prod19 = {'WATER C NUTS': list(datos['WATER C NUTS'])}
			dict_prod20 = {'KIDNEY BEANS': list(datos['KIDNEY BEANS'])}
			dict_prod21 = {'NAVY BEANS': list(datos['NAVY BEANS'])}
			dict_prod22 = {'GARBANZO': list(datos['GARBANZO'])}
			dict_prod23 = {'CUT SPINACH': list(datos['CUT SPINACH'])}
			dict_prod24 = {'GREEN PEPPER ST': list(datos['GREEN PEPPER ST'])}
			...
			Dict_Final = {}
			Dict_Final['CELERY'] = list(datos['CELERY'])
			Dict_Final['ONION STRIPS'] = list(datos['ONION STRIPS'])
			Dict_Final['CHINESE PEAS'] = list(datos['CHINESE PEAS'])
			Dict_Final['PEAS'] = list(datos['PEAS'])
			Dict_Final['SUGAR SNAP P'] = list(datos['SUGAR SNAP P'])
			Dict_Final['CORN WHOLE'] = list(datos['CORN WHOLE'])
			Dict_Final['CORN GRAINS'] = list(datos['CORN GRAINS'])
			Dict_Final['FRENCH CUT G BEANS'] = list(datos['FRENCH CUT G BEANS'])
			Dict_Final['SLAB CUT G BEANS'] = list(datos['SLAB CUT G BEANS'])
			Dict_Final['WHOLE G BEANS'] = list(datos['WHOLE G BEANS'])
			Dict_Final['ITALIAN G BEANS'] = list(datos['ITALIAN G BEANS'])
			Dict_Final['LIMA BEANS'] = list(datos['LIMA BEANS'])
			Dict_Final['CUT GREEN BEANS'] = list(datos['CUT GREEN BEANS'])
			Dict_Final['MUSHROOMS'] = list(datos['MUSHROOMS'])
			Dict_Final['RED PEPPER DCD'] = list(datos['RED PEPPER DCD'])
			Dict_Final['RED PEPPER ST'] = list(datos['RED PEPPER ST'])
			Dict_Final['POBLANO ST'] = list(datos['POBLANO ST'])
			Dict_Final['POTATOE DCD'] = list(datos['POTATOE DCD'])
			Dict_Final['WATER C NUTS'] = list(datos['WATER C NUTS'])
			Dict_Final['KIDNEY BEANS'] = list(datos['KIDNEY BEANS'])
			Dict_Final['NAVY BEANS'] = list(datos['NAVY BEANS'])
			Dict_Final['GARBANZO'] = list(datos['GARBANZO'])
			Dict_Final['CUT SPINACH'] = list(datos['CUT SPINACH'])
			Dict_Final['GREEN PEPPER ST'] = list(datos['GREEN PEPPER ST'])
	...
	def update_totals(self):
		...
		print('la suma del producto 2 es ', key_prod_2, acum_prod_2)
		self.lblTotalAnualProd_2.setText(str(acum_prod_2))

		dict_prod3 = {}
		dict_prod3['CHINESE PEAS'] = list([
		...
		print('la suma del producto 3 es ', key_prod_3, acum_prod_3)
		self.lblTotalAnualProd_3.setText(str(acum_prod_3))

		dict_prod4 = {}
		dict_prod4['PEAS'] = list([
		...
		print('la suma del producto 4 es ', key_prod_4, acum_prod_4)
		self.lblTotalAnualProd_4.setText(str(acum_prod_4))

		dict_prod5 = {}
		dict_prod5['SUGAR SNAP P'] = list([
		...
		print('la suma del producto 5 es ', key_prod_5, acum_prod_5)
		self.lblTotalAnualProd_5.setText(str(acum_prod_5))

		dict_prod6 = {}
		dict_prod6['CORN WHOLE'] = list([
		...
		print('la suma del producto 6 es ', key_prod_6, acum_prod_6)
		self.lblTotalAnualProd_6.setText(str(acum_prod_6))

		dict_prod7 = {}
		dict_prod7['CORN GRAINS'] = list([
		...
		print('la suma del producto 7 es ', key_prod_7, acum_prod_7)
		self.lblTotalAnualProd_7.setText(str(acum_prod_7))

		dict_prod8 = {}
		dict_prod8['FRENCH CUT G BEANS'] = list([
		...
		print('la suma del producto 8 es ', key_prod_8, acum_prod_8)
		self.lblTotalAnualProd_8.setText(str(acum_prod_8))

		dict_prod9 = {}
		dict_prod9['SLAB CUT G BEANS'] = list([
		...
		print('la suma del producto 9 es ', key_prod_9, acum_prod_9)
		self.lblTotalAnualProd_9.setText(str(acum_prod_9))

		dict_prod10 = {}
		dict_prod10['WHOLE G BEANS'] = list([
		...
		print('la suma del producto 10 es ', key_prod_10, acum_prod_10)
		self.lblTotalAnualProd_10.setText(str(acum_prod_10))

		dict_prod11 = {}
		dict_prod11['ITALIAN G BEANS'] = list([
		...
		print('la suma del producto 12 es ', key_prod_12, acum_prod_12)
		self.lblTotalAnualProd_12.setText(str(acum_prod_12))

		dict_prod13 = {}
		dict_prod13['CUT GREEN BEANS'] = list([
		...
		print('la suma del producto 13 es ', key_prod_13, acum_prod_13)
		self.lblTotalAnualProd_13.setText(str(acum_prod_13))

		dict_prod14 = {}
		dict_prod14['MUSHROOMS'] = list([
		...
		print('la suma del producto 14 es ', key_prod_14, acum_prod_14)
		self.lblTotalAnualProd_14.setText(str(acum_prod_14))

		dict_prod15 = {}
		dict_prod15['RED PEPPER DCD'] = list([
		...
		print('la suma del producto 15 es ', key_prod_15, acum_prod_15)
		self.lblTotalAnualProd_15.setText(str(acum_prod_15))

		dict_prod16 = {}
		dict_prod16['RED PEPPER ST'] = list([
		...
		print('la suma del producto 16 es ', key_prod_16, acum_prod_16)
		self.lblTotalAnualProd_16.setText(str(acum_prod_16))

		dict_prod17 = {}
		dict_prod17['POBLANO ST'] = list([
		...
		print('la suma del producto 17 es ', key_prod_17, acum_prod_17)
		self.lblTotalAnualProd_17.setText(str(acum_prod_17))

		dict_prod18 = {}
		dict_prod18['POTATOE DCD'] = list([
		...
		print('la suma del producto 19 es ', key_prod_19, acum_prod_19)
		self.lblTotalAnualProd_19.setText(str(acum_prod_19))

		dict_prod20 = {}
		dict_prod20['KIDNEY BEANS'] = list([
		...
		print('la suma del producto 20 es ', key_prod_20, acum_prod_20)
		self.lblTotalAnualProd_20.setText(str(acum_prod_20))

		dict_prod21 = {}
		dict_prod21['NAVY BEANS'] = list([
		...
		print('la suma del producto 22 es ', key_prod_22, acum_prod_22)
		self.lblTotalAnualProd_22.setText(str(acum_prod_22))

		dict_prod23 = {}
		dict_prod23['CUT SPINACH'] = list([
		...
		print('la suma del producto 23 es ', key_prod_23, acum_prod_23)
		self.lblTotalAnualProd_23.setText(str(acum_prod_23))

		dict_prod24 = {}
		dict_prod24['GREEN PEPPER ST'] = list([
		...
		print('la suma del producto 24 es ', key_prod_24, acum_prod_24)
		...
		print('la suma del producto 25 es ', key_prod_25, acum_prod_25)
		...
		print('la suma del producto 26 es ', key_prod_26, acum_prod_26)
		...
		print('la suma del producto 27 es ', key_prod_27, acum_prod_27)
		...
		print('la suma del producto 28 es ', key_prod_28, acum_prod_28)
		...
		print('la suma del producto 29 es ', key_prod_29, acum_prod_29)
		...
		print('la suma del producto 30 es ', key_prod_30, acum_prod_30)
		...
		print('la suma del producto 31 es ', key_prod_31, acum_prod_31)
		...
		print('la suma del producto 32 es ', key_prod_32, acum_prod_32)
		...
		print('la suma del producto 33 es ', key_prod_33, acum_prod_33)
		...
		print('la suma del producto 34 es ', key_prod_34, acum_prod_34)
		...
		dict_total_inventories_Ingredients = {}
		dict_total_inventories_Ingredients['total Inventories'] = list([
			np_total_Jan, np_total_Feb, np_total_Mar, 
			np_total_Apr, np_total_May, np_total_Jun, 
			np_total_Jul, np_total_Aug, np_total_Sep, 
			np_total_Oct, np_total_Nov, np_total_Dec])
		print('diccionario de Ingredients Inventories', dict_total_inventories_Ingredients)
	...
	def inicializar_campós(self,datos):
		...
		prod8 = datos.get('FRENCH CUT G BEANS')
		...
		prod9 = datos.get('SLAB CUT G BEANS')
		...
		prod10 = datos.get('WHOLE G BEANS')
		...
		prod11 = datos.get('ITALIAN G BEANS')
		...
		prod13 = datos.get('CUT GREEN BEANS')
		...
		prod15 = datos.get('RED PEPPER DCD')
		...
		prod16 = datos.get('RED PEPPER ST')
		...
		prod24 = datos.get('GREEN PEPPER ST')
	...
	def genera_excel(self,datos):
		import inventories_ingredients_xls_report_generator
		genera_reporte = inventories_ingredients_xls_report_generator
