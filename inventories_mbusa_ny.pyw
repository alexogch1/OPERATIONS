...
"""
In thismodule it is input the data of MB Import sales
"""
...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		list_ingredients = ['BROCCOLI', 'ORGANIC BROCCOLI', 'CAULIFLOWER', 'ORGANIC CAULIFLOWER', 'BLENDS',
							'ORGANIC BLENDS', 'BRUSSELS SPROUTS', ' YELLOW SQUASH', 'GREEN ZUCCHINI', 'SUGAR SNAP PEAS',
							 'CARROTS', 'PICKLES', 'MELONS', 'EDAMAME', 'prod15', 
		...
		self.setupUi(self)
		self.Title.setText(str('INVENTORIES MB USA'))
	...
	def search_In_File(self, year):
		...
		datos = pd.read_csv('inventoriesmbusa.csv', index_col = 0, encoding = 'utf-8' )
	...
	def update_totals(self):
		...
		print('la suma del producto 1 es ', key_prod_2, acum_prod_2)
		...
		print('la suma del producto 1 es ', key_prod_3, acum_prod_3)
		...
		print('la suma del producto 1 es ', key_prod_4, acum_prod_4)
		...
		print('la suma del producto 1 es ', key_prod_5, acum_prod_5)
		...
		print('la suma del producto 1 es ', key_prod_6, acum_prod_6)
		...
		print('la suma del producto 1 es ', key_prod_7, acum_prod_7)
		...
		print('la suma del producto 1 es ', key_prod_8, acum_prod_8)
		...
		print('la suma del producto 1 es ', key_prod_9, acum_prod_9)
		...
		print('la suma del producto 1 es ', key_prod_10, acum_prod_10)
		self.lblTotalAnualProd_10.setText(str(acum_prod_10))


		dict_prod11 = {}
		dict_prod11['Prod'] = list([
		...
		print('la suma del producto 11 es ', key_prod_11, acum_prod_11)
		self.lblTotalAnualProd.setText(str(acum_prod_11))
		...
		print('la suma del producto 1 es ', key_prod_12, acum_prod_12)
		...
		print('la suma del producto 1 es ', key_prod_13, acum_prod_13)
		...
		print('la suma del producto 1 es ', key_prod_14, acum_prod_14)
		...
		print('la suma del producto 1 es ', key_prod_15, acum_prod_15)
		...
		print('la suma del producto 1 es ', key_prod_16, acum_prod_16)
		...
		print('la suma del producto 1 es ', key_prod_17, acum_prod_17)
		...
		print('la suma del producto 1 es ', key_prod_18, acum_prod_18)
		...
		print('la suma del producto 1 es ', key_prod_19, acum_prod_19)
		...
		print('la suma del producto 1 es ', key_prod_20, acum_prod_20)
		self.lblTotalAnualProd_20.setText(str(acum_prod_20))

		dict_prod21 = {}
		dict_prod21['Prod'] = list([
		...
		print('la suma del producto 21 es ', key_prod_21, acum_prod_21)
		self.lblTotalAnualProd.setText(str(acum_prod_21))
		...
		print('la suma del producto 1 es ', key_prod_22, acum_prod_22)
		self.lblTotalAnualProd_12.setText(str(acum_prod_12))
		...
		print('la suma del producto 1 es ', key_prod_23, acum_prod_23)
		...
		print('la suma del producto 1 es ', key_prod_24, acum_prod_24)
		...
		print('la suma del producto 1 es ', key_prod_25, acum_prod_25)
		...
		print('la suma del producto 1 es ', key_prod_26, acum_prod_26)
		...
		print('la suma del producto 1 es ', key_prod_27, acum_prod_27)
		...
		print('la suma del producto 1 es ', key_prod_28, acum_prod_28)
		...
		print('la suma del producto 1 es ', key_prod_29, acum_prod_29)
		...
		print('la suma del producto 1 es ', key_prod_30, acum_prod_30)
		...
		print('la suma del producto 1 es ', key_prod_31, acum_prod_31)
		...
		print('la suma del producto 1 es ', key_prod_32, acum_prod_32)
		...
		print('la suma del producto 1 es ', key_prod_33, acum_prod_33)
		...
		print('la suma del producto 1 es ', key_prod_34, acum_prod_34)
	...
	def inicializar_campós(self):
		...
		self.lEditJanProd_11.insert(str(0))
		self.lEditFebProd_11.insert(str(0))
		self.lEditMarProd_11.insert(str(0))
		self.lEditAprProd_11.insert(str(0))
		self.lEditMayProd_11.insert(str(0))
		self.lEditJunProd_11.insert(str(0))
		self.lEditJulProd_11.insert(str(0))
		self.lEditAugProd_11.insert(str(0))
		self.lEditSepProd_11.insert(str(0))
		self.lEditOctProd_11.insert(str(0))
		self.lEditNovProd_11.insert(str(0))
		self.lEditDecProd_11.insert(str(0))

		self.lEditJanProd_12.insert(str(0))
		self.lEditFebProd_12.insert(str(0))
		self.lEditMarProd_12.insert(str(0))
		self.lEditAprProd_12.insert(str(0))
		self.lEditMayProd_12.insert(str(0))
		self.lEditJunProd_12.insert(str(0))
		self.lEditJulProd_12.insert(str(0))
		self.lEditAugProd_12.insert(str(0))
		self.lEditSepProd_12.insert(str(0))
		self.lEditOctProd_12.insert(str(0))
		self.lEditNovProd_12.insert(str(0))
		self.lEditDecProd_12.insert(str(0))

		self.lEditJanProd_13.insert(str(0))
		self.lEditFebProd_13.insert(str(0))
		self.lEditMarProd_13.insert(str(0))
		self.lEditAprProd_13.insert(str(0))
		self.lEditMayProd_13.insert(str(0))
		self.lEditJunProd_13.insert(str(0))
		self.lEditJulProd_13.insert(str(0))
		self.lEditAugProd_13.insert(str(0))
		self.lEditSepProd_13.insert(str(0))
		self.lEditOctProd_13.insert(str(0))
		self.lEditNovProd_13.insert(str(0))
		self.lEditDecProd_13.insert(str(0))

		self.lEditJanProd_14.insert(str(0))
		self.lEditFebProd_14.insert(str(0))
		self.lEditMarProd_14.insert(str(0))
		self.lEditAprProd_14.insert(str(0))
		self.lEditMayProd_14.insert(str(0))
		self.lEditJunProd_14.insert(str(0))
		self.lEditJulProd_14.insert(str(0))
		self.lEditAugProd_14.insert(str(0))
		self.lEditSepProd_14.insert(str(0))
		self.lEditOctProd_14.insert(str(0))
		self.lEditNovProd_14.insert(str(0))
		self.lEditDecProd_14.insert(str(0))

		self.lEditJanProd_15.insert(str(0))
		self.lEditFebProd_15.insert(str(0))
		self.lEditMarProd_15.insert(str(0))
		self.lEditAprProd_15.insert(str(0))
		self.lEditMayProd_15.insert(str(0))
		self.lEditJunProd_15.insert(str(0))
		self.lEditJulProd_15.insert(str(0))
		self.lEditAugProd_15.insert(str(0))
		self.lEditSepProd_15.insert(str(0))
		self.lEditOctProd_15.insert(str(0))
		self.lEditNovProd_15.insert(str(0))
		self.lEditDecProd_15.insert(str(0))

		self.lEditJanProd_16.insert(str(0))
		self.lEditFebProd_16.insert(str(0))
		self.lEditMarProd_16.insert(str(0))
		self.lEditAprProd_16.insert(str(0))
		self.lEditMayProd_16.insert(str(0))
		self.lEditJunProd_16.insert(str(0))
		self.lEditJulProd_16.insert(str(0))
		self.lEditAugProd_16.insert(str(0))
		self.lEditSepProd_16.insert(str(0))
		self.lEditOctProd_16.insert(str(0))
		self.lEditNovProd_16.insert(str(0))
		self.lEditDecProd_16.insert(str(0))

		self.lEditJanProd_17.insert(str(0))
		self.lEditFebProd_17.insert(str(0))
		self.lEditMarProd_17.insert(str(0))
		self.lEditAprProd_17.insert(str(0))
		self.lEditMayProd_17.insert(str(0))
		self.lEditJunProd_17.insert(str(0))
		self.lEditJulProd_17.insert(str(0))
		self.lEditAugProd_17.insert(str(0))
		self.lEditSepProd_17.insert(str(0))
		self.lEditOctProd_17.insert(str(0))
		self.lEditNovProd_17.insert(str(0))
		self.lEditDecProd_17.insert(str(0))

		self.lEditJanProd_18.insert(str(0))
		self.lEditFebProd_18.insert(str(0))
		self.lEditMarProd_18.insert(str(0))
		self.lEditAprProd_18.insert(str(0))
		self.lEditMayProd_18.insert(str(0))
		self.lEditJunProd_18.insert(str(0))
		self.lEditJulProd_18.insert(str(0))
		self.lEditAugProd_18.insert(str(0))
		self.lEditSepProd_18.insert(str(0))
		self.lEditOctProd_18.insert(str(0))
		self.lEditNovProd_18.insert(str(0))
		self.lEditDecProd_18.insert(str(0))

		self.lEditJanProd_19.insert(str(0))
		self.lEditFebProd_19.insert(str(0))
		self.lEditMarProd_19.insert(str(0))
		self.lEditAprProd_19.insert(str(0))
		self.lEditMayProd_19.insert(str(0))
		self.lEditJunProd_19.insert(str(0))
		self.lEditJulProd_19.insert(str(0))
		self.lEditAugProd_19.insert(str(0))
		self.lEditSepProd_19.insert(str(0))
		self.lEditOctProd_19.insert(str(0))
		self.lEditNovProd_19.insert(str(0))
		self.lEditDecProd_19.insert(str(0))

		self.lEditJanProd_20.insert(str(0))
		self.lEditFebProd_20.insert(str(0))
		self.lEditMarProd_20.insert(str(0))
		self.lEditAprProd_20.insert(str(0))
		self.lEditMayProd_20.insert(str(0))
		self.lEditJunProd_20.insert(str(0))
		self.lEditJulProd_20.insert(str(0))
		self.lEditAugProd_20.insert(str(0))
		self.lEditSepProd_20.insert(str(0))
		self.lEditOctProd_20.insert(str(0))
		self.lEditNovProd_20.insert(str(0))
		self.lEditDecProd_20.insert(str(0))

		self.lEditJanProd_21.insert(str(0))
		self.lEditFebProd_21.insert(str(0))
		self.lEditMarProd_21.insert(str(0))
		self.lEditAprProd_21.insert(str(0))
		self.lEditMayProd_21.insert(str(0))
		self.lEditJunProd_21.insert(str(0))
		self.lEditJulProd_21.insert(str(0))
		self.lEditAugProd_21.insert(str(0))
		self.lEditSepProd_21.insert(str(0))
		self.lEditOctProd_21.insert(str(0))
		self.lEditNovProd_21.insert(str(0))
		self.lEditDecProd_21.insert(str(0))

		self.lEditJanProd_22.insert(str(0))
		self.lEditFebProd_22.insert(str(0))
		self.lEditMarProd_22.insert(str(0))
		self.lEditAprProd_22.insert(str(0))
		self.lEditMayProd_22.insert(str(0))
		self.lEditJunProd_22.insert(str(0))
		self.lEditJulProd_22.insert(str(0))
		self.lEditAugProd_22.insert(str(0))
		self.lEditSepProd_22.insert(str(0))
		self.lEditOctProd_22.insert(str(0))
		self.lEditNovProd_22.insert(str(0))
		self.lEditDecProd_22.insert(str(0))

		self.lEditJanProd_23.insert(str(0))
		self.lEditFebProd_23.insert(str(0))
		self.lEditMarProd_23.insert(str(0))
		self.lEditAprProd_23.insert(str(0))
		self.lEditMayProd_23.insert(str(0))
		self.lEditJunProd_23.insert(str(0))
		self.lEditJulProd_23.insert(str(0))
		self.lEditAugProd_23.insert(str(0))
		self.lEditSepProd_23.insert(str(0))
		self.lEditOctProd_23.insert(str(0))
		self.lEditNovProd_23.insert(str(0))
		self.lEditDecProd_23.insert(str(0))

		self.lEditJanProd_24.insert(str(0))
		self.lEditFebProd_24.insert(str(0))
		self.lEditMarProd_24.insert(str(0))
		self.lEditAprProd_24.insert(str(0))
		self.lEditMayProd_24.insert(str(0))
		self.lEditJunProd_24.insert(str(0))
		self.lEditJulProd_24.insert(str(0))
		self.lEditAugProd_24.insert(str(0))
		self.lEditSepProd_24.insert(str(0))
		self.lEditOctProd_24.insert(str(0))
		self.lEditNovProd_24.insert(str(0))
		self.lEditDecProd_24.insert(str(0))

		self.lEditJanProd_25.insert(str(0))
		self.lEditFebProd_25.insert(str(0))
		self.lEditMarProd_25.insert(str(0))
		self.lEditAprProd_25.insert(str(0))
		self.lEditMayProd_25.insert(str(0))
		self.lEditJunProd_25.insert(str(0))
		self.lEditJulProd_25.insert(str(0))
		self.lEditAugProd_25.insert(str(0))
		self.lEditSepProd_25.insert(str(0))
		self.lEditOctProd_25.insert(str(0))
		self.lEditNovProd_25.insert(str(0))
		self.lEditDecProd_25.insert(str(0))

		self.lEditJanProd_26.insert(str(0))
		self.lEditFebProd_26.insert(str(0))
		self.lEditMarProd_26.insert(str(0))
		self.lEditAprProd_26.insert(str(0))
		self.lEditMayProd_26.insert(str(0))
		self.lEditJunProd_26.insert(str(0))
		self.lEditJulProd_26.insert(str(0))
		self.lEditAugProd_26.insert(str(0))
		self.lEditSepProd_26.insert(str(0))
		self.lEditOctProd_26.insert(str(0))
		self.lEditNovProd_26.insert(str(0))
		self.lEditDecProd_26.insert(str(0))

		self.lEditJanProd_27.insert(str(0))
		self.lEditFebProd_27.insert(str(0))
		self.lEditMarProd_27.insert(str(0))
		self.lEditAprProd_27.insert(str(0))
		self.lEditMayProd_27.insert(str(0))
		self.lEditJunProd_27.insert(str(0))
		self.lEditJulProd_27.insert(str(0))
		self.lEditAugProd_27.insert(str(0))
		self.lEditSepProd_27.insert(str(0))
		self.lEditOctProd_27.insert(str(0))
		self.lEditNovProd_27.insert(str(0))
		self.lEditDecProd_27.insert(str(0))

		self.lEditJanProd_28.insert(str(0))
		self.lEditFebProd_28.insert(str(0))
		self.lEditMarProd_28.insert(str(0))
		self.lEditAprProd_28.insert(str(0))
		self.lEditMayProd_28.insert(str(0))
		self.lEditJunProd_28.insert(str(0))
		self.lEditJulProd_28.insert(str(0))
		self.lEditAugProd_28.insert(str(0))
		self.lEditSepProd_28.insert(str(0))
		self.lEditOctProd_28.insert(str(0))
		self.lEditNovProd_28.insert(str(0))
		self.lEditDecProd_28.insert(str(0))

		self.lEditJanProd_29.insert(str(0))
		self.lEditFebProd_29.insert(str(0))
		self.lEditMarProd_29.insert(str(0))
		self.lEditAprProd_29.insert(str(0))
		self.lEditMayProd_29.insert(str(0))
		self.lEditJunProd_29.insert(str(0))
		self.lEditJulProd_29.insert(str(0))
		self.lEditAugProd_29.insert(str(0))
		self.lEditSepProd_29.insert(str(0))
		self.lEditOctProd_29.insert(str(0))
		self.lEditNovProd_29.insert(str(0))
		self.lEditDecProd_29.insert(str(0))

		self.lEditJanProd_30.insert(str(0))
		self.lEditFebProd_30.insert(str(0))
		self.lEditMarProd_30.insert(str(0))
		self.lEditAprProd_30.insert(str(0))
		self.lEditMayProd_30.insert(str(0))
		self.lEditJunProd_30.insert(str(0))
		self.lEditJulProd_30.insert(str(0))
		self.lEditAugProd_30.insert(str(0))
		self.lEditSepProd_30.insert(str(0))
		self.lEditOctProd_30.insert(str(0))
		self.lEditNovProd_30.insert(str(0))
		self.lEditDecProd_30.insert(str(0))

		self.lEditJanProd_31.insert(str(0))
		self.lEditFebProd_31.insert(str(0))
		self.lEditMarProd_31.insert(str(0))
		self.lEditAprProd_31.insert(str(0))
		self.lEditMayProd_31.insert(str(0))
		self.lEditJunProd_31.insert(str(0))
		self.lEditJulProd_31.insert(str(0))
		self.lEditAugProd_31.insert(str(0))
		self.lEditSepProd_31.insert(str(0))
		self.lEditOctProd_31.insert(str(0))
		self.lEditNovProd_31.insert(str(0))
		self.lEditDecProd_31.insert(str(0))

		self.lEditJanProd_32.insert(str(0))
		self.lEditFebProd_32.insert(str(0))
		self.lEditMarProd_32.insert(str(0))
		self.lEditAprProd_32.insert(str(0))
		self.lEditMayProd_32.insert(str(0))
		self.lEditJunProd_32.insert(str(0))
		self.lEditJulProd_32.insert(str(0))
		self.lEditAugProd_32.insert(str(0))
		self.lEditSepProd_32.insert(str(0))
		self.lEditOctProd_32.insert(str(0))
		self.lEditNovProd_32.insert(str(0))
		self.lEditDecProd_32.insert(str(0))

		self.lEditJanProd_33.insert(str(0))
		self.lEditFebProd_33.insert(str(0))
		self.lEditMarProd_33.insert(str(0))
		self.lEditAprProd_33.insert(str(0))
		self.lEditMayProd_33.insert(str(0))
		self.lEditJunProd_33.insert(str(0))
		self.lEditJulProd_33.insert(str(0))
		self.lEditAugProd_33.insert(str(0))
		self.lEditSepProd_33.insert(str(0))
		self.lEditOctProd_33.insert(str(0))
		self.lEditNovProd_33.insert(str(0))
		self.lEditDecProd_33.insert(str(0))

		self.lEditJanProd_34.insert(str(0))
		self.lEditFebProd_34.insert(str(0))
		self.lEditMarProd_34.insert(str(0))
		self.lEditAprProd_34.insert(str(0))
		self.lEditMayProd_34.insert(str(0))
		self.lEditJunProd_34.insert(str(0))
		self.lEditJulProd_34.insert(str(0))
		self.lEditAugProd_34.insert(str(0))
		self.lEditSepProd_34.insert(str(0))
		self.lEditOctProd_34.insert(str(0))
		self.lEditNovProd_34.insert(str(0))
		self.lEditDecProd_34.insert(str(0))
	...
	def genera_archivo_csv(self, list_keys,year):
		...
		for i, valor in enumerate(valores):
			...
			datos.loc[int(nuevo_valor)]= [
				...
				valor[36], valor[37]]
		try: 
			datos.to_csv('inventoriesmbusa.csv',  encoding = 'utf-8',) 
	...
	def set_titles(self,list_ingredients):
		...
		print(list_ingredients[3],' ', 'prod4', list_ingredients[3] == 'prod4')
		print(list_ingredients[4],' ', 'prod5', list_ingredients[4] == 'prod5')
		print(list_ingredients[5], ' ','prod6', list_ingredients[5] == 'prod6')
		print(list_ingredients[6],' ', 'prod7', list_ingredients[6] == 'prod7')
		print(list_ingredients[7],' ', 'prod8', list_ingredients[7] == 'prod8')
		print(list_ingredients[8],' ', 'prod9', list_ingredients[8] == 'prod9')
		print(list_ingredients[9],' ', 'prod10', list_ingredients[9] == 'prod10')
		print(list_ingredients[10],' ', 'prod11', list_ingredients[10] == 'prod11')
		print(list_ingredients[11],' ', 'prod12', list_ingredients[11] == 'prod12')
		print(list_ingredients[12],' ', 'prod13', list_ingredients[12] == 'prod13')
		print(list_ingredients[13],' ', 'prod14', list_ingredients[13] == 'prod14')
		print(list_ingredients[14],' ', 'prod15', list_ingredients[14] == 'prod15')
		print(list_ingredients[15],' ', 'prod16', list_ingredients[15] == 'prod16')
		print(list_ingredients[16],' ', 'prod17', list_ingredients[16] == 'prod17')
		print(list_ingredients[17],' ', 'prod18', list_ingredients[17] == 'prod18')
		print(list_ingredients[18],' ', 'prod19', list_ingredients[18] == 'prod19')
		print(list_ingredients[19],' ', 'prod20', list_ingredients[19] == 'prod20')
		print(list_ingredients[20],' ', 'prod21', list_ingredients[20] == 'prod21')
		print(list_ingredients[21],' ', 'prod22', list_ingredients[21] == 'prod22')
		print(list_ingredients[22],' ', 'prod23', list_ingredients[22] == 'prod23')
		print(list_ingredients[23],' ', 'prod24', list_ingredients[23] == 'prod24')
		print(list_ingredients[24],' ', 'prod25', list_ingredients[24] == 'prod25')
		print(list_ingredients[25],' ', 'prod26', list_ingredients[25] == 'prod26')
		print(list_ingredients[26],' ', 'prod27', list_ingredients[26] == 'prod27')
		print(list_ingredients[27],' ', 'prod28', list_ingredients[27] == 'prod28')
		print(list_ingredients[28],' ', 'prod29', list_ingredients[28] == 'prod29')
		print(list_ingredients[29],' ', 'prod30', list_ingredients[29] == 'prod30')
		print(list_ingredients[30],' ', 'prod31', list_ingredients[30] == 'prod31')
		print(list_ingredients[31],' ', 'prod32', list_ingredients[31] == 'prod32')
		print(list_ingredients[32],' ', 'prod33', list_ingredients[32] == 'prod33')
		print(list_ingredients[33],' ', 'prod34', list_ingredients[33] == 'prod34')
		...
		if list_ingredients[8] == 'prod9':
			...
			print('debe aparecer el titulo de Green zucchini')
			self.lblProd_9.setVisible(True)
