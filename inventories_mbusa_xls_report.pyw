...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		self.lblTotalAnual.setText(str('Inventario Total'))
	...
	def read_data_from_file(self, year):	
			...
			dict_prod = {'BROCCOLI': list(datos['BROCCOLI'])}
			dict_prod2 = {'ORGANIC BROCCOLI': list(datos['ORGANIC BROCCOLI'])}
			dict_prod3 = {'CAULIFLOWER': list(datos['CAULIFLOWER'])}
			dict_prod4 = {'ORGANIC CAULIFLOWER': list(datos['ORGANIC CAULIFLOWER'])}
			dict_prod5 = {'BLENDS': list(datos['BLENDS'])}
			dict_prod6 = {'ORGANIC BLENDS': list(datos['ORGANIC BLENDS'])}
			dict_prod7 = {'BRUSSELS SPROUTS': list(datos['BRUSSELS SPROUTS'])}
			dict_prod8 = {'YELLOW SQUASH': list(datos['YELLOW SQUASH'])}
			dict_prod9 = {'GREEN ZUCCHINI': list(datos['GREEN ZUCCHINI'])}
			dict_prod10 = {'SUGAR SNAP PEAS': list(datos['SUGAR SNAP PEAS'])}
			dict_prod11 = {'CARROTS': list(datos['CARROTS'])}
			dict_prod12 = {'PICKLES': list(datos['PICKLES'])}
			dict_prod13 = {'MELONS': list(datos['MELONS'])}
			dict_prod14 = {'EDAMAME': list(datos['EDAMAME'])}
			...
			Dict_Final = {}
			Dict_Final['BROCCOLI'] = list(datos['BROCCOLI'])
			Dict_Final['ORGANIC BROCCOLI'] = list(datos['ORGANIC BROCCOLI'])
			Dict_Final['CAULIFLOWER'] = list(datos['CAULIFLOWER'])
			Dict_Final['ORGANIC CAULIFLOWER'] = list(datos['ORGANIC CAULIFLOWER'])
			Dict_Final['BLENDS'] = list(datos['BLENDS'])
			Dict_Final['ORGANIC BLENDS'] = list(datos['ORGANIC BLENDS'])
			Dict_Final['BRUSSELS SPROUTS'] = list(datos['BRUSSELS SPROUTS'])
			...
			Dict_Final['CARROTS'] = list(datos['CARROTS'])
			Dict_Final['PICKLES'] = list(datos['PICKLES'])
			Dict_Final['MELONS'] = list(datos['MELONS'])
			Dict_Final['EDAMAME'] = list(datos['EDAMAME'])
	...
	def update_totals(self):
		...
		dict_prod2 = {}
		dict_prod2['ORGANIC BROCCOLI'] = list([
		...
		dict_prod4 = {}
		dict_prod4['ORGANIC CAULIFLOWER'] = list([
		...
		dict_prod6 = {}
		dict_prod6['ORGANIC BLENDS'] = list([
		...
		dict_prod7 = {}
		dict_prod7['BRUSSELS SPROUTS'] = list([
		...
		dict_prod9 = {}
		dict_prod9['GREEN ZUCCHINI'] = list([
		...
		dict_prod10 = {}
		dict_prod10['SUGAR SNAP PEAS'] = list([
		...
		dict_total_Mbusa_Inventories['total Inventories'] = list([
			np_total_Jan, np_total_Feb, np_total_Mar, 
			np_total_Apr, np_total_May, np_total_Jun, 
			np_total_Jul, np_total_Aug, np_total_Sep, 
			np_total_Oct, np_total_Nov, np_total_Dec])
		print('diccionario de Inventarios MBUSA', dict_total_Mbusa_Inventories)
	...
	def inicializar_campós(self,datos):
		...
		prod2 = datos.get('ORGANIC BROCCOLI')
		...
		prod4 = datos.get('ORGANIC CAULIFLOWER')
		...
		prod6 = datos.get('ORGANIC BLENDS')
		...
		prod7 = datos.get('BRUSSELS SPROUTS')
		...
		prod9 = datos.get('GREEN ZUCCHINI')
		...
		prod10 = datos.get('SUGAR SNAP PEAS')
	...
	def genera_excel(self,datos):
		import inventarios_mbusa_xls_report
		genera_reporte = inventarios_mbusa_xls_report
