...
form_class = uic.loadUiType("mbusasales.ui")[0]
...
class MyWindowClass(QtWidgets.QDialog, form_class):
    ...
    def genera_archivo_csv(self, list_keys,year):
        ...
        print(data_dict)
        mensaje = 'se van a guardar los datos en el archivo'
        ...
        try: 
            ...
            ex = 'El archivo datos_produccion.csv se encuentra abierto: ' + str(ex)
            print(ex)
