...
"""
In this module it is input the data of Production
"""
...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		list_ingredients = [ 'BROCC. CONV.', 'BROCC. ORG.', 'CAULIF. CONV.', 'CAULIF. ORG.', 'CARROTS CONV.',
								'CARROTS ORG.', 'ZUCCHINI', 'YLLOW SQ.', 'ONION', 'CORN GRAINS',
								'POBLANO', 'ROMANESCO', 'MUSHROOMS', 'CELERY', 'MAQUILA',
		...
		self.setupUi(self)
		self.Title.setText(str('MB MEX PRODUCTION'))
	...
	def search_In_File(self, year):
		...
		datos = pd.read_csv('production.csv', index_col = 0, encoding = 'utf-8' )
	...
	def genera_archivo_csv(self, list_keys,year):
		...
		for i, valor in enumerate(valores):
			...
			datos.loc[int(nuevo_valor)]= [
				...
				valor[36], valor[37]]
		try: 
			datos.to_csv('production.csv',  encoding = 'utf-8',) 
