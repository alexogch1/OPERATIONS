...
class Dialogo(QDialog):
	def __init__(self):
		...
		self.setWindowTitle("Production") #Título
	...
	def Seleccionar(self):
		...
		self.table.setHorizontalHeaderLabels(['ID', 'indice', 'year', 'month', 
								'BROCC. CONV.', 'BROCC. ORG.', 'CAULIF. CONV.', 'CAULIF. ORG.', 'CARROTS CONV.',
	...
	def Actualizar(self):
					...
					elif nombre_columna == 'BROCC. CONV.' :
						prod0 = value
						print(year)
						datos.loc[id] = [ id_datos, year,  month,
						prod0, prod1, prod2, prod3, prod4, 
					...
					elif nombre_columna == 'CAULIF. CONV.' :
						prod2 = value
						print(year)
						datos.loc[id] = [ id_datos, year,  month,
						prod0, prod1, prod2, prod3, prod4, 
					...
					elif nombre_columna == 'CARROTS CONV.' :
						prod4 = value
						print(year)
						datos.loc[id] = [ id_datos, year,  month,
						prod0, prod1, prod2, prod3, prod4, 
	...
	def Eliminar(self):
		datos = pd.read_csv('production.csv', index_col = 0)
