...
"""
In thismodule it is input the data of pRODUCTION
"""
...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		self.Title.setText(str('PRODUCTION'))
	...
	def read_data_from_file(self, year):	
			...
			dict_prod = {'BROCC. CONV.': list(datos['BROCC. CONV.'])}
			dict_prod2 = {'BROCC. ORG.': list(datos['BROCC. ORG.'])}
			dict_prod3 = {'CAULIF. CONV.': list(datos['CAULIF. CONV.'])}
			dict_prod4 = {'CAULIF. ORG.': list(datos['CAULIF. ORG.'])}
			dict_prod5 = {'CARROTS CONV.': list(datos['CARROTS CONV.'])}
			dict_prod6 = {'CARROTS ORG.': list(datos['CARROTS ORG.'])}
			dict_prod7 = {'ZUCCHINI': list(datos['ZUCCHINI'])}
			dict_prod8 = {'YLLOW SQ.': list(datos['YLLOW SQ.'])}
			dict_prod9 = {'ONION': list(datos['ONION'])}
			dict_prod10 = {'CORN GRAINS': list(datos['CORN GRAINS'])}
			dict_prod11 = {'POBLANO': list(datos['POBLANO'])}
			dict_prod12 = {'ROMANESCO': list(datos['ROMANESCO'])}
			dict_prod13 = {'MUSHROOMS': list(datos['MUSHROOMS'])}
			dict_prod14 = {'CELERY': list(datos['CELERY'])}
			dict_prod15 = {'MAQUILA': list(datos['MAQUILA'])}
	...
	def genera_excel(self,datos):
		import production_xls_report_generator
		genera_reporte = production_xls_report_generator
