...
class XLS():
    ...
    def genera_reporte(self,datos):
        ...
        self.sheet1 = self.book.add_sheet('IMPORT PURCHASES')          # Crea las columnas con los datos correspondientes
    ...
    def main_body_sht(self,hoja):
        ...
        np_group5 = np_prod21 + np_prod22 + np_prod23 + np_prod24 + np_prod25 
        np_group6 = np_prod26 + np_prod27 + np_prod28 + np_prod29 + np_prod30  
        np_group7 = np_prod31 + np_prod32 + np_prod33 + np_prod34
        
        np_Total_import_Purchases = np_group1 + np_group2 + np_group3 + np_group4 + np_group5 + np_group6 + np_group7
        print(np_Total_import_Purchases)
        total_import_Purchases = np_Total_import_Purchases.tolist()
        print('Total Purchases ', total_import_Purchases[0])
        dict_total_import_Purchases = {}
        dict_total_import_Purchases['total import Purchases'] = total_import_Purchases[0]
        print(dict_total_import_Purchases)
        values = list(dict_total_import_Purchases.values())
        producto = list(dict_total_import_Purchases.keys())
        np_Total_import_Purchases = np.array(values)
        acum = np_Total_import_Purchases.sum()
        columna = 35
        ...
        np_carrots = np_prod2 + np_prod5 +  np_prod30
        total_Carrots  = np_carrots.tolist()
        print('Total Purchases Carrots Conv  ', total_Carrots[0])
        dict_total_import_Carrots = {}
        dict_total_import_Carrots['total Conv Carrots'] = total_Carrots[0]
        print(dict_total_import_Carrots)
        values = list(dict_total_import_Carrots.values())
        producto = list(dict_total_import_Carrots.keys())
        np_Total_import_carrots = np.array(values)
        acum = np_Total_import_carrots.sum()
        columna = 39
        self.ingresa_datos(hoja,columna,producto,values,acum)      


        np_carrots_org = np_prod3 + np_prod4 + np_prod10
        total_Carrots_Org  = np_carrots_org.tolist()
        print('Total Purchases Carrots Org  ', total_Carrots_Org[0])
        dict_total_import_Carrots_Org = {}
        dict_total_import_Carrots_Org['total Org Carrots'] = total_Carrots_Org[0]
        print(dict_total_import_Carrots_Org)
        values = list(dict_total_import_Carrots_Org.values())
        producto = list(dict_total_import_Carrots_Org.keys())
        np_Total_import_carrots_Org = np.array(values)
        acum = np_Total_import_carrots_Org.sum()
        columna = 40
        self.ingresa_datos(hoja,columna,producto,values,acum)      

        np_greenbeans = np_prod6 + np_prod7 + np_prod24 + np_prod27
        total_greenbeans  = np_greenbeans.tolist()
        print('Total Purchases Green Beans  ', total_greenbeans[0])
        dict_total_import_Green_Beans = {}
        dict_total_import_Green_Beans['total Green Beans'] = total_greenbeans[0]
        print(dict_total_import_Green_Beans)
        values = list(dict_total_import_Green_Beans.values())
        producto = list(dict_total_import_Green_Beans.keys())
        np_Total_import_greenBeans = np.array(values)
        acum = np_Total_import_greenBeans.sum()
        columna = 41
        self.ingresa_datos(hoja,columna,producto,values,acum)         

        np_corn = np_prod16 + np_prod17
        total_Corn  = np_corn.tolist()
        print('Total Purchases Corn  ', total_Corn[0])
        dict_total_import_corn = {}
        dict_total_import_corn['total Corn'] = total_Corn[0]
        print(dict_total_import_corn)
        values = list(dict_total_import_corn.values())
        producto = list(dict_total_import_corn.keys())
        np_Total_import_corn = np.array(values)
        acum = np_Total_import_corn.sum()
        columna = 42
        self.ingresa_datos(hoja,columna,producto,values,acum)

        np_broccoli = np_prod9 + np_prod28
        total_broccoli  = np_broccoli.tolist()
        print('Total Purchases Broccoli  ', total_broccoli[0])
        dict_total_import_Broccoli = {}
        dict_total_import_Broccoli['total Total Broccoli'] = total_broccoli[0]
        print(dict_total_import_Broccoli)
        values = list(dict_total_import_Broccoli.values())
        producto = list(dict_total_import_Broccoli.keys())
        np_Total_import_Brocoli = np.array(values)
        acum = np_Total_import_Brocoli.sum()
        columna = 43
        self.ingresa_datos(hoja,columna,producto,values,acum)            
