...
"""
In this module is generated the report of Other Sales
"""
...
class XLS():
    ...
    def genera_reporte(self,datos):
        ...
        self.sheet1 = self.book.add_sheet('OTHERS SALES')          # Crea las columnas con los datos correspondientes
    ...
    def main_body_sht(self,hoja):
        ...
        np_group1 = np_prod + np_prod2 
        
        
        np_Total_Other_sales = np_group1 
        print(np_Total_Other_sales)
        Total_Others_Sales = np_Total_Other_sales.tolist()
        print('Total OTHERS Sales ', Total_Others_Sales[0])
        dict_total_Others_Sales = {}
        dict_total_Others_Sales['total OTHERS Sales'] = Total_Others_Sales[0]
        print(dict_total_Others_Sales)
        values = list(dict_total_Others_Sales.values())
        producto = list(dict_total_Others_Sales.keys())
        np_Total_Otherssales = np.array(values)
        acum = np_Total_Otherssales.sum()
        columna = 12
        ...
        np_Total_Brocc = np.array(values)
        acum = np_Total_Brocc.sum()
        columna = 13
        self.ingresa_datos(hoja,columna,producto,values,acum)      


        np_Cauliflower = np_prod2 
        total_Cauliflower  = np_Cauliflower.tolist()
        print('Total Cauliflower ', total_Cauliflower[0])
        dict_total_Cauliflower = {}
        dict_total_Cauliflower['total Cauliflower'] = total_Cauliflower[0]
        print(dict_total_Cauliflower)
        values = list(dict_total_Cauliflower.values())
        producto = list(dict_total_Cauliflower.keys())
        np_Total_Caulif = np.array(values)
        acum = np_Total_Caulif.sum()
        columna = 14
        self.ingresa_datos(hoja,columna,producto,values,acum)      
