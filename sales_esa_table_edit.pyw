...
class Dialogo(QDialog):
	...
	def Seleccionar(self):
		...
		self.table.setHorizontalHeaderLabels(['ID', 'indice', 'year', 'month', 
												'Br. Flrts 1 - 2 1/8','Br Stalks','Br Pearls' ,'Col. Flrts 1 - 2 1/8', 'Col. Flrts 3/4 - 1 3/8', 
	...
	def Actualizar(self):
					...
					elif nombre_columna == "Br. Flrts 1 - 2 1/8" :
					...
					elif nombre_columna == "Col. Flrts 1 - 2 1/8" :
					...
					elif nombre_columna == "Col. Flrts 3/4 - 1 3/8" :
					...
					elif nombre_columna == "Col Nuggets" :
					...
					elif nombre_columna == "Yellow Squash" :
					...
					elif nombre_columna == "Green Zucchini" :
	...
	def Eliminar(self):
		datos = pd.read_csv('esasales.csv', index_col = 0)
