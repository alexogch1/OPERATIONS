...
"""
In this module is generated the report of ESA Sales
"""
...
class XLS():
    ...
    def genera_reporte(self,datos):
        ...
        self.sheet1 = self.book.add_sheet('ESA SALES')          # Crea las columnas con los datos correspondientes
    ...
    def main_body_sht(self,hoja):
        ...
        np_group2 = np_prod6+ np_prod7 + np_prod8 + np_prod9 
        
        np_Total_esa_sales = np_group1 + np_group2 
        print(np_Total_esa_sales)
        Total_Esa_Sales = np_Total_esa_sales.tolist()
        print('Total ESA Sales ', Total_Esa_Sales[0])
        dict_total_Esa_Sales = {}
        dict_total_Esa_Sales['total ESA Sales'] = Total_Esa_Sales[0]
        print(dict_total_Esa_Sales)
        values = list(dict_total_Esa_Sales.values())
        producto = list(dict_total_Esa_Sales.keys())
        np_Total_Esasales = np.array(values)
        acum = np_Total_Esasales.sum()
        columna = 12
        ...
        np_Broccoli = np_prod + np_prod2 +  np_prod3 
        ...
        np_Cauliflower = np_prod4 + np_prod5 +  np_prod6 
