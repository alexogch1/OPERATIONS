...
"""
In thismodule it is input the data of Others Sales
"""
...
class MyWindowClass(QtWidgets.QDialog, form_class):
	def __init__(self, parent=None):
		...
		list_ingredients = ['Arnime Broccoli Fines','Prox. Est. Caulif. Nuggets', 'prod3' ,'prod4', 'prod5', 
		...
		self.setupUi(self)
		self.Title.setText(str('Others Sales'))
		self.lblTotalAnual.setText(str('OTHERS SALES'))
	...
	def search_In_File(self, year):
		...
		datos = pd.read_csv('otherssales.csv', index_col = 0, encoding = 'utf-8' )
	...
	def genera_archivo_csv(self, list_keys,year):
		...
		for i, valor in enumerate(valores):
			...
			datos.loc[int(nuevo_valor)]= [
				...
				valor[36], valor[37]]
		try: 
			datos.to_csv('otherssales.csv',  encoding = 'utf-8',) 
