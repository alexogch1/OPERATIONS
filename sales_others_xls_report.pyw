...
"""
In thismodule it is input the data of Sales Others
"""
...
class MyWindowClass(QtWidgets.QDialog, form_class):
	...
	def read_data_from_file(self, year):	
			...
			dict_prod = {'Arnime Broccoli Fines': list(datos['Arnime Broccoli Fines'])}
			dict_prod2 = {'Prox. Est. Caulif. Nuggets': list(datos['Prox. Est. Caulif. Nuggets'])}
			dict_prod3 = {'prod3': list(datos['prod3'])}
			dict_prod4 = {'prod4': list(datos['prod4'])}
			...
			Dict_Final = {}
			Dict_Final['Arnime Broccoli Fines'] = list(datos['Arnime Broccoli Fines'])
			Dict_Final['Prox. Est. Caulif. Nuggets'] = list(datos['Prox. Est. Caulif. Nuggets'])
			Dict_Final['prod3'] = list(datos['prod3'])
			Dict_Final['prod4'] = list(datos['prod4'])
	...
	def update_totals(self):
		...
		dict_prod = {}
		dict_prod['Arnime Broccoli Fines'] = list([
		...
		dict_prod2 = {}
		dict_prod2['Prox. Est. Caulif. Nuggets'] = list([
		...
		dict_total_Esa_Sales['total Sales'] = list([
			...
			np_total_Jul, np_total_Aug, np_total_Sep, 
			np_total_Oct, np_total_Nov, np_total_Dec])
		print('diccionario de Other Sales', dict_total_Esa_Sales)
	...
	def inicializar_campós(self,datos):
		...
		"""
		print(datos)
		prod = datos.get('Arnime Broccoli Fines')
		...
		prod2 = datos.get('Prox. Est. Caulif. Nuggets')
	...
	def genera_excel(self,datos):
		import sales_Others_xls_report_generator
		genera_reporte = sales_Others_xls_report_generator
